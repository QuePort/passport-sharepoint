...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (spAppToken && spSiteUrl) {
  ...
  } else if (req != undefined && req.query && req.query.code && req.query.authorizationURL && authorizationURL.tokenURL) {
    this._oauth2 = new OAuth2(this._appId, this._appSecret, '', req.query.authorizationURL, req.query.tokenURL);
    ...
    this._oauth2 = new OAuth2(this._appId,  this._appSecret, '', req.query.authorizationURL, authorizationURL.tokenURL);
  ...
  var req = https.get(options, function(res) {
    ...
    res.on('end', function() {
      ...
      if (json.d) {
        ...
        return done('SharePoint authentication failed: ' + json.error.code, null);
      else
