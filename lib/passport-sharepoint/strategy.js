...
Strategy.prototype.authenticate = function(req, options) {
  ...
  // you can pass the ClientId and Secret in every round
  if (options.clientID)
    this._clientID = options.clientID;
  if (options.clientSecret)
    this._clientSecret = options.clientSecret;
    
  if (!this._clientID) throw new Error('SharePointStrategy requires a clientID.');
  if (!this._clientSecret) throw new Error('SharePointStrategy requires a clientSecret.');
