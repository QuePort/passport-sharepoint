  ...
  var req = https.get(options, function(res) {
    ...
    res.on('end', function() {
      ...
      if (json.d) {
        ...
        console.log("DEBUG end: " + JSON.stringify(json) + "  " + JSON.stringify(options));
    ...
    console.log("DEBUG error: " + e + "  " + JSON.stringify(options));
    return done('Authentication failed. ' + e, null);
  });
}
