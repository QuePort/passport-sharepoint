...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.body.SPAppToken && req.query.SPHostUrl) {
    ...
    this._resource = splitApptxSender[0]+"/"+sharepointServer.host+"@"+splitApptxSender[1];
    ...
    this._authorizationURL = this._spHostUrl + '/_layouts/15/OAuthAuthorize.aspx';
    this._tokenURL = tokenServiceUri.protocol+'//'+tokenServiceUri.host+'/'+splitApptxSender[1]+tokenServiceUri.path;

    this._oauth2 = new OAuth2(spClientID,  this._clientSecret, '', this._authorizationURL, this._tokenURL);
    this._oauth2.getOAuthAccessToken(
        token.refreshtoken,
        {grant_type: 'refresh_token', refresh_token: token.refreshtoken, resource: this._resource},
    ...
    this._oauth2 = new OAuth2(this._clientID, this._clientSecret, '', this._authorizationURL, this._tokenURL);
    ...
    this._oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', resource: this._resource, redirect_uri: callbackURL },
